...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Quản lý slide</h2>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('slide.create') }}" class="btn btn-primary">Thêm mới</a>
                </div>
                                ...
                                <tbody>
                                    @foreach($data as $key => $value)
                                        <tr>
                                            ...
                                            <td>{{ $value->status }}</td>
                                            <td>
                                                <a href="{{ route('slide.edit', $value->id) }}" class="btn btn-primary">
