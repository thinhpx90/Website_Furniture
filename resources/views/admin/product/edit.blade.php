        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('product.update', $data->id) }}" id="form-product" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-xl-6 col-md-6 col-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') border border-danger @enderror" name="name" id="basicInput" value="{{ $data->name }}">
                                        @error('name')
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <select name="type_product_id" class="form-control @error('type_product_id') border border-danger @enderror" id="basicInput">
                                            @foreach($types as $key => $value)
                                                <option value="{{ $value->id }}" {{ $data->type_product_id == $value->id ? 'selected' : '' }}>{{ $value->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <select name="supplier_id" class="form-control @error('supplier_id') border border-danger @enderror" id="basicInput">
                                            @foreach($suppliers as $key => $value)
                                                <option value="{{ $value->id }}" {{ $data->supplier_id == $value->id ? 'selected' : '' }}>{{ $value->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('supplier_id')
                                            <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="col-xl-6 col-md-6 col-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('origin') border border-danger @enderror" name="origin" id="basicInput" value="{{ $data->origin }}">
                                        @error('origin')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </fieldset>
                                ...
                                <div class="col-xl-6 col-md-6 col-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('material') border border-danger @enderror" name="material" id="basicInput" value="{{ $data->material }}">
                                        @error('material')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </fieldset>
                                ...
                                <div class="col-xl-6 col-md-6 col-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('size') border border-danger @enderror" name="size" id="basicInput" value="{{ $data->size }}">
                                        @error('size')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </fieldset>
                                ...
                                <div class="col-xl-6 col-md-6 col-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('unit_price') border border-danger @enderror" name="unit_price" id="basicInput" value="{{ $data->unit_price }}">
                                        @error('unit_price')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </fieldset>
                                ...
                                <div class="col-xl-6 col-md-6 col-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('promotion_price') border border-danger @enderror" name="promotion_price" id="basicInput" value="{{ $data->promotion_price }}">
                                ...
                                <div class="col-xl-6 col-md-6 col-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('unit') border border-danger @enderror" name="unit" id="basicInput" value="{{ $data->unit }}">
                                        @error('unit')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </fieldset>
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <div class="images">
                                            @foreach($data->images as $key => $value)
                                                <div class="img saved" style="background-image: url({{ asset(Storage::url('public/uploads/' . $value->image)) }})" data-whatever="{{ $value->id }}">
                                                    <span>remove</span>
                                                </div>
                                            @endforeach
                                            <div class="pic">
                                ...
                                <div class="col-xl-6 col-md-6 col-12 mb-1">
                                    <input type="submit" class="btn btn-primary" id="send" value="Sửa">
