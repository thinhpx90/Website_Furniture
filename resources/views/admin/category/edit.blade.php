...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Sửa danh mục</h2>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 col-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') border border-danger @enderror" name="name" id="basicInput" value="{{ old('name', isset($category) ? $category->name : '') }}">
                                        @error('name')
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <select name="type_product_id" class="form-control @error('type_product_id') border border-danger @enderror" id="basicInput">
                                            @foreach($typeProduct as $key => $value)
                                                @if($category->type_product_id == $value->id)
                                ...
                                <div class="col-xl-12 col-md-12 col-12 mb-1">
                                    <fieldset class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('description') border border-danger @enderror" name="description" id="basicInput" value="{{ old('description', isset($category) ? $category->description : '') }}">
                                        @error('description')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </fieldset>
